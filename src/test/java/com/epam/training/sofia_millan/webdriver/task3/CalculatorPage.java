...
public class CalculatorPage {
    ...
    public void fillForm() throws InterruptedException {
        ...
        //Operating system
        driver.findElement(By.xpath("//div[contains(@class, 'VfPpkd-TkwUic') and .//span[contains(@class, 'VfPpkd-NLUYnc-V67aGc-OWXEXe-TATcMc-KLRBe') and contains(text(), 'Operating System')]]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li[@data-value='free-debian-centos-coreos-ubuntu-or-byol-bring-your-own-license']")).click();
        Thread.sleep(3000);
        ...
        //Machine type
        driver.findElement(By.xpath("//div[contains(@class, 'VfPpkd-TkwUic') and .//span[contains(@class, 'VfPpkd-NLUYnc-V67aGc-OWXEXe-TATcMc-KLRBe') and contains(text(), 'Machine type')]]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li[@data-value='n1-standard-8']")).click();
        Thread.sleep(1000);
